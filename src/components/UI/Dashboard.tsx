        ...
        <div className={`px-5 sm:px-2 bg-white text-black w-full flex justify-between
         ${darkMode && 'bg-slate-900 text-gray-300'}`}>
            <div className={'my-2 flex brightness-125'}>
                <img className={'w-14 my-auto sm:w-8 sm:h-8'} src="https://cryptologos.cc/logos/aave-aave-logo.png" alt=""/>
            ...
            <div className={'my-auto flex'}>
                <span className={'uppercase tracking-wider sm:tracking-normal my-auto mx-2 sm:text-sm sm:lowercase'}>Light</span>
                <label className={'switch'}>
                    <input type="checkbox" onClick={isDarkMode} defaultChecked={darkMode}/>
                    <span className={'slider'}></span>
                </label>
                <span className={'uppercase tracking-wider sm:tracking-normal my-auto mx-2 sm:text-sm sm:lowercase'}>Dark</span>
            </div>
        </div>
    );
};
